...
namespace UnitTestChallenge
{
    ...
    public class UnitTest1
    {
        ...
        {
            string chapter =   @"My father's family name being Pirrip, and my Christian name Philip, my infant tongue could make of both names nothing longer or more explicit than Pip. So, I called myself Pip, and came to be called Pip.
            ...
            var challenge = new RegexChallenge.Challenge();

            Assert.AreEqual(challenge.Execute(chapter), 367);
        }
    }
}
